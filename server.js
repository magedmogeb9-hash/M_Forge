...
// Simple health check — useful for confirming the server is actually
// running and reachable (locally or once deployed to a host).
app.get("/", (req, res) => {
    res.json({ status: "ok", service: "Classify AI Commerce OS" });
});
